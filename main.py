...
def run_routine(chosen_month):
  ...
  array1 = SolarTrackerArray(1,89.5,359)
  ...
  while running_init == True:
    ...
    if wind_safe == True:
      ...
      if daytime == True:
        ...
        elif 270 < array1.sun_direction[1] < 360 and 0 < the_sun.sun_pos_angles[1] < 90:
          array1.increment_array_azi_angle()
          #move forward across axis
        
        elif 0 < array1.sun_direction[1] < 90 and 270 < the_sun.sun_pos_angles[1]< 360:
          array1.decrement_array_azi_angle()
